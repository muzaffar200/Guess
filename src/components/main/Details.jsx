                ...
                singleProduct ?
                    <div className='flex max-768:block'>
                        <div className='w-[80%] flex flex-wrap gap-[10px] max-1024:hidden'>
                            {
                                singleProduct.images.map((item, i) => {
                                    return (
                                        <img key={i} className='w-[49%]' src={item} alt="" />
                                    )
                                })
                        ...
                        <div>
                            ...
                            <div className=' sticky top-[15px] w-[400px] pl-[25px] max-768:w-full max-768:pl-0 max-768:pt-[30px]'>
                                    ...
                                    <div className='flex gap-[5px] cursor-pointer'>
                                        {
                                            singleProduct.Colors.map((item, i) => {
                                                return (
                                                    <div key={i} onClick={() => { SetColor(item) }}
                                ...
                                <p className='flex items-center w-full pt-[15px]'>This product promotes <span className='underline ml-[5px]'>Sustainability </span><PiPlantThin className='text-[#018740] ml-[5px] text-[20px]' /></p>
                            </div>
                        </div>
                    </div>
